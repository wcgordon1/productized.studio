    ...
    return (
      <input
        ...
        className={cn(
          ...
          // "shadow-[0_0_0_1px_rgba(0,0,0,0.1)_inset,0_0.5px_0.5px_rgba(0,0,0,0.05)_inset,0_-0.5px_0.5px_rgba(0,0,0,0.05)_inset,0_0.5px_1px_rgba(0,0,0,0.1),0_1px_1px_rgba(0,0,0,0.1)]",
