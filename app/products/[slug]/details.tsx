...
const tagsMap = [
  <MessageSquareTextIcon className="h-4 w-4 md:h-6 md:w-6 stroke-1" />,
  <Edit2Icon className="h-4 w-4 md:h-6 md:w-6 stroke-1" />,
  <Sparkles className="h-4 w-4 md:h-6 md:w-6 stroke-1" />,
  <HeartIcon className="h-4 w-4 md:h-6 md:w-6 stroke-1" />,
]
