...
const p = () => new Promise((resolve) => setTimeout(() => resolve(""), 1900))
...
export const SubmitTool = () => {
  ...
  const [state, formAction] = useFormState(submitProductFormAction, {
    message: "",
    issues: [],
  })
      ...
      <form
        ...
        onSubmit={async (evt) => {
          ...
          await form.handleSubmit(async (data) => {
            ...
            setLoading(false)
            await submitProductFormAction(state, formData)
